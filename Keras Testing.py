...
c1 = Conv2D(64, (32,32), activation='elu', kernel_initializer='he_normal', padding='same') (s)
d1 = Dropout(0.2) (c1)
outputs = Conv2D(3, (1, 1), activation='softmax', kernel_initializer='he_normal', padding='same') (c1)
